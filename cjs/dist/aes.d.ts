...
export declare function exportKey(key: CryptoKey): Promise<Uint8Array<ArrayBuffer>>;
...
export declare function decrypt(key: CryptoKey, data: Uint8Array, iv: Uint8Array): Promise<Uint8Array<ArrayBuffer>>;
