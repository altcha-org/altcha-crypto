...
export declare function encrypt(publicKey: CryptoKey, data: Uint8Array): Promise<Uint8Array<ArrayBuffer>>;
export declare function decrypt(privateKey: CryptoKey, data: Uint8Array): Promise<Uint8Array<ArrayBuffer>>;
...
export declare function exportPublicKeyFromPrivateKey(privateKey: CryptoKey): Promise<Uint8Array<ArrayBuffer>>;
