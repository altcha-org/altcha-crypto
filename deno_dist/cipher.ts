...
import type { ICipherEncryptOptions } from './types.ts';
...
export async function decrypt(privateKeyRSA: CryptoKey, data: Uint8Array) {
...
export function readHead(data: Uint8Array) {
